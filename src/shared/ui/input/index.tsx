...
const classes = {
  filled: "px-5 bg-gray-200 rounded-2xl",
    ...
    return (
      <label className="flex flex-col gap-2">
        <div className="flex gap-2">
          <span
            className={twMerge(
              "font-secondary pl-6 text-gray-700",
              labelHidden && "hidden",
              errors && "text-red-400",
            )}
          >
        ...
        <input
          ...
          required={required}
          className={twMerge(
            "text-xl py-3 transition-all outline-3 outline-transparent -outline-offset-4 focus-visible:outline-offset-0 focus-visible:outline-gray-500 w-[min(20rem,_100%)]",
            classes[variant],
