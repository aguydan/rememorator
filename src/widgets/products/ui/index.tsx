...
export default function Products() {
  return (
    <div className="flex flex-col items-center gap-30 mt-30 cursor-pointer">
      <section className="grid grid-cols-2 sm:grid-cols-4 auto-rows-[9rem] gap-2 w-[min(50rem,_96%)]">
      ...
      <div className="flex flex-col sm:flex-row gap-2 bg-yellow-200 py-2 px-14 rounded-3xl w-[min(70rem,_96%)] mb-40">
        <AddProductButton />
